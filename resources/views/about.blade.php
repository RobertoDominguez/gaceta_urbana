...
<body>
    ...
    <main class="mb-4">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <p>Somos una organización civil comprometida con la investigación y
                        difusión del contenido académico, científico y crítico.
                        Buscamos informar sobre las hechos más relevantes a nivel
                        Santa Cruz de la Sierra, a nivel Bolivia y a nivel global.</p>
                    <p></p>
                </div>
            </div>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <img class="" src="{{ asset('blog/assets/img/logo.jpg') }}" alt="post_image">
                </div>
            </div>
