        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('blog')}}">Articulos</a></li>
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('about')}}">Acerca de</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                @foreach ($covers as $cover)
                    ...
                    <div class="post-preview">
                        <a href="{{ route('posts', $cover->id) }}">
                            <h2 class="post-title">{{ $cover->title }}</h2>
                            <img class="img-thumbnail mt-4" src="{{ asset('/storage/' . $cover->image_url) }}"
                                alt="post_image">
                ...
                @if (!$fin)
                    ...
                    <div class="d-flex justify-content-end mb-4">
                        <form action="{{ route('blog') }}" method="GET">
                            {{ csrf_field() }}
                            <input name="pagination" value="{{ $pagination + 5 }}" hidden>
